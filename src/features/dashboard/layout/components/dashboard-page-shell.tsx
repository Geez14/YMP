...
export function DashboardPageShell({ children, aside, asideClassName, songLimitText, textSecondary, contentSurface, contentSurfaceColor }: DashboardPageShellProps) {
  return (
